package com.zenyone.core.helper;

import com.zenyone.core.model.LicenseCreatorParam;
import com.zenyone.core.model.LicenseVerifyManager;
import com.zenyone.core.model.LicenseVerifyParam;
...
public class ParamInitHelper {
    ...
    /** 证书的发行者和主体字段信息 */
    private final static X500Principal DEFAULT_HOLDER_AND_ISSUER = new X500Principal("CN=zenyone, OU=zenyone, O=zenyone, L=gd, ST=sz, C=CN");
